...
--rollback drop sequence `Address`;
...
--rollback drop table bank_details;
--rollback drop sequence bank_details;
...
--rollback drop table `Data`;
--rollback drop sequence `Data`;


--changeset sergio:4
create table if not exists `datapincode` (
  `ID` int DEFAULT NULL,
  `CircleName` text,
  `RegionName` text,
  `DivisionName` text,
...
--rollback drop sequence `Education`;
...
INSERT INTO `Users` VALUES (1,'2022-04-24 20:28:18','pritamkhose@gmail.com','Pritam','Khose','9876543210',0);
